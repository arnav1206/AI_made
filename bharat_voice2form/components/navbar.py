...
Features official Formitra darkmode multilingual brand logo with image shifted left and up.
"""
...
def _logo_block() -> None:
    ...
    try:
        ...
        logo_html = (
            ...
            f'display:block;margin:-10px auto 0.4rem auto;transform:translateX(-14px);" />'
        )
    except Exception:
